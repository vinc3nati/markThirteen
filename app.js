...
var bdayInp = document.querySelector("#bday-inp");
var showBtn = document.querySelector("#btn");
var outputDiv = document.querySelector("#bday-out");

function clickHandler(e) {
  var bdayString = bdayInp.value;
  ...
  if (bdayString !== "") {
    ...
    if (!isPalindrome) {
      ...
      if (ctr1 > ctr2) {
        ...
        outputDiv.innerText = `The nearest palindrome date is ${nextDate.day}-${nextDate.month}-${nextDate.year}, it's ${ctr1} days from the entered date 😉.`;
      }
    } else {
      outputDiv.innerText = "Yay! Your birthday is palindrome! 🥳";
    }
  } else {
    outputDiv.innerText = "Please Enter Valid Date";
  }
}
